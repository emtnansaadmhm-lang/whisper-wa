...
### تغيير بيانات الأدمن:
عدّل ملف `database.py`:
```python
def create_admin_user():
    cursor.execute("""
    INSERT INTO users (name, email, password_hash, ...)
    VALUES ('Your Name', 'your@email.com', hash_password('your_password'), ...)
    """)
```
...
if __name__ == "__main__":
    app.run(debug=True, host="0.0.0.0", port=5000)  # غيّر الرقم
```
...
1. ✅ **لا تستخدم في بيئة الإنتاج** بدون تعديلات أمنية إضافية
2. ✅ **غيّر بيانات الأدمن الافتراضية** فوراً
3. ✅ **استخدم HTTPS** في البيئة الحقيقية
4. ✅ **لا تشارك قاعدة البيانات** علناً
5. ✅ **احفظ النسخ الاحتياطية** بشكل دوري

---

## 📝 الترخيص

هذا المشروع **تعليمي** ومصمم لأغراض **البحث الأكاديمي** فقط.

⚠️ **تنبيه قانوني:**
- لا يجوز استخدامه لأغراض غير قانونية
- يجب الحصول على موافقة قانونية قبل تحليل أي بيانات
...
- 📧 Email: support@whisper-wa.local
- 📚 Documentation: [Wiki](#)
...
**صُنع بـ ❤️ لأغراض التعليم والبحث الأكاديمي**
